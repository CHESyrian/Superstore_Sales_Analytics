...
# [The Questions](assets/html/phase2_business_questions.html)
...
![Alt text](assets/images/superstore_analytics_methodology.svg)

---

Those 5 python libraries cover the full analytics pipeline for this dataset. Let me map out exactly how each one fits into your project, and flag where we might extend later.Here's how each library slots into the project, and where they hand off to each other:

![Alt text](assets/images/python_toolkit_map.svg)
